...
from ..routers.auth import router as auth_router, router
...
async def create_todo(user: user_dependency, db: db_dependency, todo_request: TodoRequest):
    ...
    db.add(todo)
    db.commit() #add dedikten sonra commit demezsek işlem yapılmaz
...
def create_todo_with_gemini(todo_string: str):
    ...
    response = llm.invoke(
        [
            HumanMessage(content= "I will provide you a todo item to add my to do list. What I want you to do is to create a longer and more comprehensive description, my next message will be my todo"),
